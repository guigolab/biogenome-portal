<template>
  ...
  <va-data-table :items="assemblies" :columns="['accession', 'scientific_name', 'assembly_name','assembly_level', 'actions']">
    <template #cell(actions)="{ rowData }">
      <va-chip :disabled="rowData.metadata.assembly_level === 'Scaffold' || rowData.metadata.assembly_level === 'Contig'" :to="{ name: 'annotation-form', params: { assemblyAccession: rowData.accession, taxid: rowData.taxid } }" icon="edit"
        >Add Annotation</va-chip
      >
