CHECKLIST_FIELD_GROUPS = [
        ...
        {'fields': [
			...
			{'label': 'specimen_id', 'description': 'Unique identifier used to link all data for the recorded specimen.', 'type': 'text_field', 'mandatory': 'mandatory', 'multiplicity': 'single'}, 
		], 
        ...
        {'fields': [
				...
				{'label': 'sample_unique_name', 'description':'the sample unique name will be the ID of the submission to the ENA','type': 'text_field', 'mandatory': 'mandatory', 'multiplicity': 'single'},
...
EXCEL_PARSER= {
        ...
        'ORIGINAL_COLLECTION_DATE':'original collection date',
