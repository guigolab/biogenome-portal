...
import os
from db.models import Assembly,BioSample,Chromosome,CronJob
from helpers import assembly_helper,biosample_helper,cronjob_helper,taxonomy_helper, utils, sample_coordinates_helper
from db.models import CronJobStatus
DATASETS = '/ncbi/datasets'
PROJECT_ACCESSION = os.getenv('PROJECT_ACCESSION')
SEQUENCE_REPORT_ARGS = ['--report', 'sequence', '--assembly-level','chromosome,complete']
CRON_NAME = 'ncbi_import'
