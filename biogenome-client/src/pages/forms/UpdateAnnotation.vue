<template>
    <p class="va-title">Annotation Update</p>
    <va-divider />
    <va-inner-loading :loading="isLoading">
        <va-card stripe stripe-color="success" class="d-flex">
            <va-form tag="form" @submit.prevent="handleSubmit">
                ...
                <va-card-content v-if="isLocalAssembly">
                    <p>
                        Update of files is not supported. If you need to change the file, it is necessary to delete this
                        assembly
...
async function handleSubmit() {
    ...
    try {
        isLoading.value = true
        const { data } = await AuthService.updateAnnotation(props.name, requestData)
