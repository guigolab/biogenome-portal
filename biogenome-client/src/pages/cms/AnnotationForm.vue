         ...
         <VaInnerLoading :loading="isLoading">
            <div v-if="!name" class="row">
               <div class="flex lg12 md12 sm12 xs12">
                  <VaCard>
                     <VaCardContent>
                        <h2 class="va-h6">Annotation Name and Related Assembly</h2>
                        <p class="va-text-secondary">Type a unique annotation name and select the related assembly</p>
                     </VaCardContent>
                     <VaCardContent>
                        <div class="row">
            ...
            <div class="row">
               <div class="flex lg12 md12 sm12 xs12">
                  <VaCard>
                     <VaCardContent>
                        <h2 class="va-h6">Annotation Data</h2>
                        <p class="va-text-secondary">
                           Upload files or insert links to the annotations. Two types of files are required: one
                           bgzipped gff file and its tabindex version
                        </p>
                     </VaCardContent>
                     <VaCardContent>
                        <!-- Toggle Upload Mode -->
                        ...
                        <div class="row" v-if="uploadMode === 'links'">
                           <VaInput
                              class="flex lg12 md12 xs12 sm12"
                        ...
                        <div class="row" v-else>
                           <div v-if="name" class="flex lg12 md12 sm12 xs12">
                              <p>
                                 Update of uploaded files is not supported. If you need to change the file, it is
                                 necessary to delete this annotation and create a new one.
                              </p>
                           </div>
                           <div v-else class="flex lg12 md12 sm12 xs12">
                              <va-file-upload
                                 :disabled="isInputDisabled(annotationStore.annotationForm.gff_gz_location)"
                                 type="single"
                                 v-model="annotationStore.annotationForm.gzipAnnotation"
                                 dropzone
                                 drop-zone-text="Upload a gzipped GFF file"
                                 file-types=".gz"
                              />
                              <va-file-upload
                                 :disabled="isInputDisabled(annotationStore.annotationForm.tab_index_location)"
                                 type="single"
                                 v-model="annotationStore.annotationForm.tabixAnnotation"
                                 dropzone
                                 drop-zone-text="Upload the GFF tabix index file"
                                 file-types=".tbi"
                              />
                           </div>
                        </div>
