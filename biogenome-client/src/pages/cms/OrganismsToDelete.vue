   ...
   <div class="row justify-center">
      <div class="flex lg12 md12 sm12 xs12">
         <VaCard>
            <VaCardContent>
               <p>
                  Approve the deletion request or deny it, approving the request will delete the organism and all its
                  related data. This action is irreversible
               </p>
            </VaCardContent>
            ...
            <VaCardContent>
               ...
               >
                  <template #cell(approve)="{ rowData }">
                     <VaChip @click="approveRequest(rowData.taxid)" size="small" color="danger">Approve </VaChip>
                  </template>
