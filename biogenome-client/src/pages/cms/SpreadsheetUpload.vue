      ...
      <VaForm ref="uploadForm" tag="form" @submit.prevent="handleSubmit">
         <div class="row row-equal">
            <div class="flex lg6 md6 sm12 xs12">
               <VaCard>
                  <VaCardContent>
                     <h2 class="va-h6">Field Mapping</h2>
                     <p class="va-text-secondary">
                        If your spreadsheet contains columns that matches the word "lat" or "long," the system will
                        automatically generate coordinates for each sample based on the values of these columns. To
                        ensure accurate coordinate generation, it is recommended to provide decimal values for latitude
                        and longitude. If you do not wish to generate coordinates, please ensure that your spreadsheet
                        does not contain columns containing the substring: 'lat' or 'long' and with valid coordinates
                     </p>
                  </VaCardContent>
                  <VaCardContent>
                     <div class="row">
                        ...
                        <div class="flex lg12 md12 sm12 xs12">
                           <VaInput
                              ...
                              label="Scientific Name column (required)"
            ...
            <div class="flex lg6 md6 sm12 xs12">
               <VaCard>
                  <VaCardContent>
                     <h2 class="va-h6">Import Options</h2>
                     <p class="va-text-secondary">
                        Set the column row index (0 based) and the upload behaviour if a local sample with the same id
                        already exists
                     </p>
                  </VaCardContent>
                  <VaCardContent>
...
<script setup lang="ts">
   ...
   const stripeColor = computed(() =>
      uploadState.value === 'ERROR' ? 'danger' : uploadState.value === 'SUCCESS' ? 'success' : 'secondary',
   )
