<template>
         ...
         <VaCard>
            <VaCardContent>
               <div class="row justify-space-between align-center">
                  <div class="flex">
                     <h2 class="va-h6">Users Details</h2>
                  </div>
               </div>
            </VaCardContent>
            <VaCardContent>
               <div class="row">
                  ...
                  <div class="flex lg6 md6 sm12 xs12">
                     <VaSelect label="user role" v-model="user.role" :options="['DataManager', 'Admin']"> </VaSelect>
                  </div>
                  <div class="flex lg6 md6 sm12 xs12">
         ...
         <VaCard>
            <VaCardContent>
               <div class="row justify-space-between">
                  <div class="flex">
                     <h2 class="va-h6">Available Organisms</h2>
                     <p class="va-text-secondary">
                        Click over a species to assign it, start typing in the filter to show species
                     </p>
                  </div>
                  <div class="flex">
                     <VaCheckbox
                        label="Show only unassigned organisms"
                        v-model="onlyAvailableOrganisms"
            ...
            <VaCardContent>
               <div class="row">
                  <div class="flex lg12 md12 sm12 xs12">
                     <VaInput
                        clearable
                        v-model="availableSpeciesFilter"
      ...
      <div class="flex lg6 md6 sm12 xs12">
         <VaCard>
            <VaCardContent>
               <div class="row justify-space-between align-center">
                  <div class="flex">
                     <h2 class="va-h6">Assigned organisms</h2>
                     <p class="va-text-secondary">Select organisms to remove</p>
                  </div>
                  <div v-if="selectedAssignedSpecies.length" class="flex">
                     <VaButton @click="handleRemove" preset="secondary" color="danger"
                        >Remove {{ selectedAssignedSpecies.length }} Organisms</VaButton
                     >
                  </div>
               </div>
            </VaCardContent>
               ...
               <div class="row">
                  <div class="flex lg12 md12 sm12 xs12">
                     <VaDataTable
                        ...
                        v-model="selectedAssignedSpecies"
                        :filter="assignedSpeciesFilter"
                        height="400px"
                        sticky-header
                        :columns="['scientific_name', 'goat_status', 'target_list_status']"
                        :items="userOrganisms"
   ...
   <div class="row justify-space-between">
      <div class="flex lg12 md12 sm12 xs12">
         <VaButton :loading="isLoading" @click="handleSubmit" :disabled="!isValid" preset="terti" block
            >Submit
         </VaButton>
      </div>
   </div>
