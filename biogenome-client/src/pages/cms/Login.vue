            ...
            <VaCard>
               <VaForm tag="form" @submit.prevent="handleSubmit">
                  ...
                  <VaCardActions align="right">
                     <VaButton block :disabled="!name || !password" type="submit"> Login </VaButton>
                  </VaCardActions>
               </VaForm>
               <VaCardContent v-if="adminEmail">
                  <a
                     class="va-link"
                     :href="`mailto:${adminEmail}?subject=I%20Forgot%20My%20Password&body=Hello,%0D%0A%0D%0AI forgot my password and need assistance resetting it.%0D%0A%0D%0AThank you.`"
