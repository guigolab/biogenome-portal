      ...
      <VaForm ref="organismForm">
         <div v-if="!taxid" class="row">
            <div class="flex lg12 md12 sm12 xs12">
               <VaCard>
                  <VaCardContent>
                     <h2 class="va-h6">Organism Creation</h2>
                     <p class="va-text-secondary">
                        Type a valid organism name or taxid, the organism validation will be performed against the NCBI
                        and/or EBI databases
                     </p>
                  </VaCardContent>
                  <VaCardContent>
            ...
            <div class="flex lg12 md12 sm12 xs12">
               <div class="row row-equal">
                  ...
                  <div class="flex lg12 md12 ms12 xs12">
                     <VaCard>
                        <VaCardContent>
                           <h2 class="va-h6">Sub Project, PI or Entity</h2>
                           <p class="va-text-secondary">Name of the PI or Entity responsible of the organism</p>
                        </VaCardContent>
                        <VaCardContent>
                           <div class="row">
                              <div class="flex lg12 md12 sm12 xs12">
                                 <VaInput
                                    :rules="[(v: string) => Boolean(v) || 'Field is mandatory']"
                  ...
                  <div class="flex lg12 md12 ms12 xs12">
                     <VaCard>
                        <VaCardContent>
                           <h2 class="va-h6">Sequencing Type</h2>
                           <p class="va-text-secondary">Select the sequencing type</p>
                        </VaCardContent>
                        <VaCardContent>
                           <div class="row">
                              <div class="flex lg12 md12 sm12 xs12">
                                 <VaSelect
                                    v-model="organismStore.organismForm.sequencing_type"
                                    multiple
...
<script setup lang="ts">
   ...
   const title = computed(() =>
      props.taxid ? `Edit ${organismStore.organismForm.scientific_name}` : 'Create a new organism',
   )
   const description = computed(() =>
      props.taxid && organismStore.organismForm.scientific_name
         ? `Editing organism ${organismStore.organismForm.scientific_name}`
   ...
   async function getOrganism(taxid: string) {
      try {
         ...
         const formEntries = Object.entries(data).filter(([k, v]) =>
