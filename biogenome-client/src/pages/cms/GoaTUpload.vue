   ...
   <div>
                     ...
                     <VaCardContent>
                        <div class="row">
                           <div class="flex lg12 md12 sm12 xs12">
                              <VaFileUpload
                                 dropzone
                                 uploadButtonText="Clik to upload a TSV"
                                 v-model="tsv"
                                 file-types=".tsv"
                                 type="single"
                                 undo
      ...
      <VaModal v-model="showModal">
         ...
         <div class="layout va-gutter-1 fluid">
            <div class="row">
               <div class="flex lg12 md12 sm12 xs12">
                  <p>Use goat report (in TSV format), to upload organisms in the portal database</p>
               </div>
               <div class="flex lg12 md12 sm12 xs12">
                  <p>
                     The TSV format must be compliant with
                     <a
                        class="va-link"
                        target="_blank"
                        href="https://docs.google.com/spreadsheets/d/1eC6jQctRoUaeGWWDbb1qsWs-7ajC462nnJdHK4N3ivw"
                        ><b>this template</b></a
                     >. Note that you have to <span class="va-text-danger">delete</span> the
                     <span class="va-text-highlighted">Click here for complete Guidelines text </span> in the TSV
                     template
                  </p>
               </div>
            </div>
            <div class="row">
               <div class="flex lg12 md12 sm12 xs12">
                  <h4 class="va-h6">About the template header:</h4>
               </div>
               <div class="flex lg12 md12 sm12 xs12">
                  <p>
                     Except for the <span class="va-text-bold"> sub_project</span> row, the template header—although
                     required for compatibility with any existing GoaT report—is not actually used in the portal.
                  </p>
               </div>
               <div class="flex lg12 md12 sm12 xs12">
                  <p>
                     If you are part of a subproject, enter the subproject name (e.g., principal investigator, entity,
                     or research institution) in the sub_project row.
                  </p>
               </div>
            </div>
         </div>
