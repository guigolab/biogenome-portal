<template>
   <VaCard>
      <VaCardContent>
         <h2 class="va-h6">Vernacular Names</h2>
         <p class="va-text-secondary">Add vernacular names</p>
      </VaCardContent>
      <VaCardContent>
         <div v-for="(name, index) in organismStore.vernacularNames" :key="index" class="row align-end">
            ...
            <div class="flex">
               <VaInput
                  ...
                  label="locality"
                  :rules="[(v: string) => v.length > 0 || 'Locality is mandatory']"
               >
               </VaInput>
            </div>
            <div class="flex">
         ...
         <div class="row">
            <div class="flex lg12 md12 sm12 xs12">
               <VaButton icon="add" @click="organismStore.vernacularNames.push({ value: '', lang: '', locality: '' })"
                  >Add add local name</VaButton
               >
            </div>
         </div>
      </VaCardContent>
