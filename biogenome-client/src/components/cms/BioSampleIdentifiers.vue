      ...
      <VaCardContent>
         <div class="row">
            <div class="flex lg12 md12 sm12 xs12">
               <h2 class="va-h5">Sample Information</h2>
               <p class="va-text-secondary">Select the organism and the sample identifier</p>
            </div>
         </div>
      </VaCardContent>
      <VaCardContent>
         ...
         <div v-if="sampleStore.scientificName && sampleStore.taxid" class="row">
            <div class="flex">
               <VaCard stripe-color="success" stripe>
                  <VaCardTitle> Selected organism </VaCardTitle>
                  <VaCardContent>
                     <h5 class="va-h5">
