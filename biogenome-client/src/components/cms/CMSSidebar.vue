   ...
   <VaSidebar activeColor="textPrimary" v-model="globalStore.adminSidebar">
         ...
         <VaCollapse>
            ...
            <template #body>
               <VaSidebarItem :to="{ name: 'create-organism' }">
                  <VaSidebarItemContent>
                     <VaSidebarItemTitle> Create New Organism </VaSidebarItemTitle>
                  </VaSidebarItemContent>
               </VaSidebarItem>
               <VaSidebarItem v-if="hasENATemplate" :to="{ name: 'publish-biosample' }">
                  <VaSidebarItemContent>
                     <VaSidebarItemTitle> Create New Biosample </VaSidebarItemTitle>
                  </VaSidebarItemContent>
               </VaSidebarItem>
         ...
         <VaCollapse>
            ...
            <template #body>
               ...
               <VaSidebarItem v-if="isAdmin" :to="{ name: 'delete-requests' }">
                  <VaSidebarItemContent>
                     <VaSidebarItemTitle> Organism Deletion Requests </VaSidebarItemTitle>
                  </VaSidebarItemContent>
               </VaSidebarItem>
               <VaSidebarItem v-if="isAdmin" :to="{ name: 'organisms-with-users' }">
                  <VaSidebarItemContent>
                     <VaSidebarItemTitle> Organisms & Users </VaSidebarItemTitle>
                  </VaSidebarItemContent>
               </VaSidebarItem>
      ...
      <VaSidebarItem :to="{ name: 'home' }">
         <VaSidebarItemContent>
            ...
            <VaSidebarItemTitle> Back to Home </VaSidebarItemTitle>
         </VaSidebarItemContent>
      </VaSidebarItem>
   </VaSidebar>
</template>
