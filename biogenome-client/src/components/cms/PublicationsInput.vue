<template>
   <VaCard>
      <VaCardContent>
         <h2 class="va-h6">Publications</h2>
      ...
      <VaCardContent>
         <div v-for="(pub, index) in organismStore.publications" :key="index" class="row align-center">
            ...
            <div class="flex">
               <VaButton
                  ...
                  preset="secondary"
                  color="danger"
                  @click="organismStore.publications.splice(index, 1)"
                  >Delete</VaButton
               >
            </div>
         </div>
         <div class="row">
            <div class="flex lg12 md12 sm12 xs12">
               <VaButton icon="add" @click="organismStore.publications.push({ id: '', source: '' })"
                  >Add new publication</VaButton
               >
            </div>
         </div>
      </VaCardContent>
