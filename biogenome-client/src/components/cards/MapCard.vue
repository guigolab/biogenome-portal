    ...
    <VaCard>
        <VaCardContent>
            <div class="row">
                <div class="flex"></div>
                <div class="flex">
                    <VaSwitch label="Map Type" v-model="mapStore.mapType" true-value="cloropleth"
                        false-value="points" />
                </div>
            </div>
        </VaCardContent>
...
const taxidQuery = computed(() => itemStore.parentTaxon?.taxid);
...
const renderChoropleth = async () => {
    ...
    const query = taxidQuery.value ? { taxon_lineage: taxidQuery.value } : {};
...
const renderPoints = async () => {
    ...
    const query = taxidQuery.value ? { taxid: taxidQuery.value } : {};
