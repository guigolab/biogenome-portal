<template>
  <va-card stripe :stripe-color="relatedData.color" class="mb-4">
    <va-card-title :class="`va-text-${relatedData.color}`">
      {{ t(relatedData.title) }}<va-icon :name="relatedData.icon" :color="relatedData.color"></va-icon>
    </va-card-title>
